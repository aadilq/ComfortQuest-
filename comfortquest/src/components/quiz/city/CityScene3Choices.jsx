// src/components/quiz/city/CityScene3Choices.jsx
import { useEffect, useState } from "react";
import bg from "../../../assets/cityscene3.png";

export default function CityScene3Choices({
  setThemeClass,
  onBack,
  ...
  return (
    <main
      role="main"
      aria-labelledby="scene3-choices"
      style={{
        position: "fixed",
        inset: 0,
        width: "100%",
    ...
    >
      ...
      >
        <h2 id="scene3-choices" style={{ margin: 0, color: "#b985ff" }}>
          What Calls to You?
        </h2>
        <p style={{ margin: "0.25rem 0 0" }}>
          Follow the beat—or the stillness between skyscrapers.
        </p>
      </header>

      <section
        aria-label="Scene 3 choices"
        style={{
          position: "absolute",
          top: "6rem",
          left: "50%",
